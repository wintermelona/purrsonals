...
const Navbar = () => {
  ...
  return <div className={classNames("navbar", scrollPosition > 0 ? 'bg-white shadow' : 'bg-transparent', 'sticky top-0 z-20 transition-all')}>
    ...
    <div className="navbar-end font-aristotelica mr-4">
        ...
        <label tabIndex={0} className="btn bg-white border-none hover:bg-white">
          <div className="indicator flex flex-col justify-center items-center">
            ...
            {status === "authenticated" ? (
              <h1 className="font-gilroyLight normal-case text-[#7a7a7a]"> {session.user.name} </h1>
            ) : (
              <h2 className="font-gilroyLight normal-case text-[#7a7a7a]"> Login </h2>
            )}
          </div>
        </label>
